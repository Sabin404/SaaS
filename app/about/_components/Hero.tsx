...
const Hero = () => {
  return (
    <section className="bg-linear-to-l from-[#706FBD] to-[#3A3F87] lg:h-145 flex relative py-12 lg:py-0 px-4 py-6">
      ...
      <div className="hidden lg:block absolute bottom-0 left-0 translate-y-20">
        <svg
          width="1726"
          height="159"
